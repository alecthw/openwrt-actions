...
# golang version
sed -i "/^GO_VERSION_MAJOR_MINOR/c\GO_VERSION_MAJOR_MINOR:=1.15"                                 package/feeds/packages/golang/Makefile
sed -i "/^GO_VERSION_PATCH/c\GO_VERSION_PATCH:=2"                                                package/feeds/packages/golang/Makefile
sed -i "/^PKG_HASH/c\PKG_HASH:=28bf9d0bcde251011caae230a4a05d917b172ea203f2a62f2c2f9533589d4b4d" package/feeds/packages/golang/Makefile
