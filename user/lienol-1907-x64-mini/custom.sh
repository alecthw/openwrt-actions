...
if [ -d "package/lean/luci-app-adbyby-plus" ]; then
    cp -f ../user/lienol-1907-x64-mini/defconfig/etc/config/adbyby           package/lean/luci-app-adbyby-plus/root/etc/config/adbyby
fi

if [ -d "package/feeds/diy1/luci-app-passwall" ]; then
    cp -f ../user/lienol-1907-x64-mini/defconfig/etc/config/passwall         package/feeds/diy1/luci-app-passwall/root/etc/config/passwall
    cp -f ../user/lienol-1907-x64-mini/defconfig/usr/share/passwall/rules/*  package/feeds/diy1/luci-app-passwall/root/usr/share/passwall/rules/
fi
...
if [ -d "package/feeds/luci/luci-app-smartdns" ]; then
    ...
    cp -f ../user/lienol-1907-x64-mini/defconfig/etc/config/smartdns         package/feeds/luci/luci-app-smartdns/root/etc/config/smartdns
    cp -f ../user/lienol-1907-x64-mini/defconfig/etc/smartdns/custom.conf    package/feeds/luci/luci-app-smartdns/root/etc/smartdns/custom.conf 
fi
